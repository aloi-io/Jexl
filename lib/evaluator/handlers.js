...
exports.Lambda = function(ast) {
  return this.evalLambda(ast)
}
 ...
 * @private
 */
exports.ParentIdentifier = function (ast) {
  if (!ast.from) {
    return this.parentMap.get(this._context)
    // return ast.relative ? this._relContext[ast.value] : this._context[ast.value]
  }
  return this.eval(ast.from).then((context) => {
    if (context === undefined) {
    ...
    return this.parentMap.get(context)
  })
}
/**
